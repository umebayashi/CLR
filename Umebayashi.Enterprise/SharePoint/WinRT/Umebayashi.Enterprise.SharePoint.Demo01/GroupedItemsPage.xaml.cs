using Umebayashi.Enterprise.SharePoint.Demo01.Data;
...
namespace Umebayashi.Enterprise.SharePoint.Demo01
{
    /// <summary>
    /// グループ化されたアイテムのコレクションを表示するページです。
    /// </summary>
    public sealed partial class GroupedItemsPage : Umebayashi.Enterprise.SharePoint.Demo01.Common.LayoutAwarePage
    {
